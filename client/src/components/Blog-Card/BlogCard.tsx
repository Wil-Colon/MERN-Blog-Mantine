...
import { Group, Image, Space, Stack, Text, rem } from "@mantine/core";
  ...
  return (
    <div className="blogcard-container">
      <Group justify="apart" className="blogcard-container__header">
        <Stack>
          <Text fw={500} className="blogcard-container__header__title">
            {"Just a Test Title"}{" "}
          </Text>

          <Text fw={300} className="blogcard-container__header__author">
